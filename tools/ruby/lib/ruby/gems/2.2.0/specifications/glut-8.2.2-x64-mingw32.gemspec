# -*- encoding: utf-8 -*-
# stub: glut 8.2.2 x64-mingw32 lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2016-01-21"
  s.description = "Glut bindings for OpenGL. To be used with the {opengl}[https://github.com/larskanis/opengl] gem."
  s.email = ["drbrain@segment7.net", "", "speed.the.bboy@gmail.com", "", "", "", ""]
  ...
  s.summary = "Glut bindings for OpenGL"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<mini_portile2>, ["~> 2.1"])
      ...
      s.add_dependency(%q<mini_portile2>, ["~> 2.1"])
