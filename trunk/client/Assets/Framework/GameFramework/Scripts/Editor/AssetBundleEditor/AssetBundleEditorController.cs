...
namespace UnityGameFramework.Editor.AssetBundleTools
{
    public sealed class AssetBundleEditorController
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<AssetBundleEditorConfigPathAttribute>() ?? Utility.Path.GetCombinePath(Application.dataPath, "Framework/GameFramework/Configs/AssetBundleEditor.xml");
