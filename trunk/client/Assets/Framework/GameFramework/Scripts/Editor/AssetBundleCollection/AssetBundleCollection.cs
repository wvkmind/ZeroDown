...
namespace UnityGameFramework.Editor.AssetBundleTools
{
    ...
    public sealed class AssetBundleCollection
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<AssetBundleCollectionConfigPathAttribute>() ?? Utility.Path.GetCombinePath(Application.dataPath, "Framework/GameFramework/Configs/AssetBundleCollection.xml");
